...
set output 'gold_imag_part_m.eps'
set autoscale 
set xtic auto
set xrange [1.5:35]    
unset yrange #[-1:10]                  
...
plot "eps_minus_drude_re_im.txt" u 1:3 w p ls 4 t "Experimental data",\
"eps_minus_drude_re_im.txt" u 1:5 w l ls 5 t "Gauss approximation"

#"eps_minus_drude_re_im.txt" u 1:7 w l ls 8 t "Kramers-Kronig transform of Re {/Symbol e} ({/Symbol w})"