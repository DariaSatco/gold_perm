...
plot "eps(w)_im.txt" u 1:2 smooth csplines w l ls 1 t "Drude-Lorentz",\
"eps(w)_im.txt" u 1:3 smooth csplines \
w l ls 3 t "Generalized Plasma",\
"eps(w)_im.txt" u 1:4 smooth csplines \
